...
The compiled HTML file is available here: https://github.com/Choton-1/practical_ML_predictionAssignment
...
dt_training<-read.csv("./data/pml-training.csv", na.strings = c("NA", "#DIV/0!", ""))
dt_testing<-read.csv("./data/pml-testing.csv", na.strings = c("NA", "#DIV/0!", ""))
...
crossval$classe <- factor(crossval$classe, levels = levels(prediction))
...
```{r}
set.seed(5656)  
training$classe <- factor(training$classe, levels = levels(prediction))
